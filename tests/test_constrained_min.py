...
class TestOptimization(unittest.TestCase):
    ...
    def execute_minimization(self, function, inequality_constraints, equality_matrix, equality_rhs, initial_point):
        optimal_point, optimal_value, inequality_values_at_optimal, path, obj_values = interior_pt(function, inequality_constraints, equality_matrix, equality_rhs, initial_point)
